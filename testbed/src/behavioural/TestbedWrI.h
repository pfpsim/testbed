#ifndef BEHAVIOURAL_TESTBEDWRI_H_
#define BEHAVIOURAL_TESTBEDWRI_H_
...
template <typename T>
class TestbedWrI : public sc_interface {
 public:
...
template<typename T>
void TestbedWrI<T>::put(const T& t) {
...
#endif  // BEHAVIOURAL_TESTBEDWRI_H_
